...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Space.default_body'
        db.add_column('sim_space', 'default_body', orm['sim.space:default_body'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Space.default_body'
        db.delete_column('sim_space', 'default_body_id')
